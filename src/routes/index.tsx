...
const OFFERS = [
  ...
  },
  {
    ...
    items: [
       ...
       { text: "Deux différentes affiches publicitaires animées pour maximiser les ventes (Andromeda) ", type: "check", prefix: "+ 2 Affiches publicitaires animée", suffix: "[35€]" },
       { text: "Un texte court et percutant pour chaque affiches publicitaires animées (Copywriting optimisé)", type: "check", prefix: "+ 2 Textes Publicitaire", suffix: "[20€]" },
  ...
  },
  {
    ...
    text: "",
    items: [
       { text: "Deux différentes vidéo publicitaires avec deux angles marketing différents pour le même produits pour maximiser les ventes. ", type: "check", prefix: "X par vidéo", suffix: "[110€]" },
       { text: "Deux différentes affiches publicitaires animées pour maximiser les ventes (Andromeda) ", type: "check", prefix: "+2 Deux affiches publicitaires animées :", suffix: "[35€]" },
       { text: "Un texte court et percutant pour chaque Affiche publicitaire animée (Copywriting optimisé) ", type: "check", prefix: "+2 Textes  publicitaires :", suffix: "[20€]" },
       { text: "Une page de vente prête à copier coller", type: "gift", prefix: "1 page de vente", suffix: "[35€]" },
